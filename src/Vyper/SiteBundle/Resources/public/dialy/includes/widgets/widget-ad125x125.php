...
class DF_ad125x125 extends WP_Widget {
	...
	function form($instance) {
		...
		$defaults = array(
			'image1' => THEME_IMAGE_URL."125x125.jpg",
			'link1' => 'http://www.different-themes.com',
			'image2' => THEME_IMAGE_URL."125x125.jpg",
			'link2' => 'http://www.different-themes.com',
			'image3' => THEME_IMAGE_URL."125x125.jpg",
			'link3' => 'http://www.different-themes.com',
			'image4' => THEME_IMAGE_URL."125x125.jpg",
		...
		<ul class="ad-banner-125x125">
			<?php 
				...
				for($i=1; $i<=4; $i++) {
					...
					if(!$image) { $image = THEME_IMAGE_URL."125x125.jpg"; }
					if($link) {
			?>
				<li>
