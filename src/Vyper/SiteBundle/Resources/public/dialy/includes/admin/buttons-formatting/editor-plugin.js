...
var differentthemesButtons=[
		{
			...
			fields:[{id:'text', name:'Text'},{id:'href', name:'Link URL'},{id:'color', name:'Color', colorpalette:true},{id:'style', name:'Button Style', values:['Normal', 'Rounded']},{id:'target', name:'Target', values:['Self', 'Blank']},{id:'icon', name:'Icon', values:df_icons()},{id:'size', name:'Size', values:['Default', 'Small', 'Large']}],
			generateHtml:function(obj){
			
				return '[button link="'+obj.href+'" target="'+obj.target.toLowerCase()+'" color="'+obj.color.toLowerCase()+'" icon="'+obj.icon.toLowerCase()+'" style="'+obj.style.toLowerCase()+'" size="'+obj.size.toLowerCase()+'"]'+obj.text+'[/button]';
		...
		},
		{
			...
			title:'Alert',
			allowSelection:false,
			fields:[{id:'type', name:'Type', values:['White', 'Grey', 'Red', 'Yellow', 'Green']}, {id:'text', name:'Text', textarea:true}],
			generateHtml:function(obj){
