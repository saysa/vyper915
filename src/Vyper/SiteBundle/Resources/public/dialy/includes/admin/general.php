...
array(
	...
	"info" => __("Works only if you leve the logo image field empty.", THEME_NAME),
	"id" => $different_themes_managment->themeslug."_subcount",
	"options"=>array(
		array("slug"=>"0", "name"=> __("None character in theme color scheme color", THEME_NAME)), 
		array("slug"=>"1", "name"=>__("1 character in theme color scheme color", THEME_NAME)),
		array("slug"=>"2", "name"=>__("2 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"3", "name"=>__("3 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"4", "name"=>__("4 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"5", "name"=>__("5 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"6", "name"=>__("6 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"7", "name"=>__("7 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"8", "name"=>__("8 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"9", "name"=>__("9 characters in theme color scheme color", THEME_NAME)),
		array("slug"=>"10", "name"=>__("10 characters in theme color scheme color", THEME_NAME)),
		),
	"std" => "5"
),
array(
...
array(
	"type" => "title",
	"title" => __("Show Post Share Buttons in Single Post", THEME_NAME)
),
...
array(
	"type" => "title",
	"title" => __("Show Post Controls (prev/next buttons) in Single Post", THEME_NAME)
),
...
array(
	"type" => "radio",
	"id" => $different_themes_managment->themeslug."_author",
	"radio" => array(
		array("title" => __("Show:", THEME_NAME), "value" => "show"),
		array("title" => __("Hide:", THEME_NAME), "value" => "hide"),
		array("title" => __("Custom For Each Post:", THEME_NAME), "value" => "custom")
...
array(
	"type" => "radio",
	"id" => $different_themes_managment->themeslug."_published",
	"radio" => array(
		array("title" => __("Show:", THEME_NAME), "value" => "show"),
		array("title" => __("Hide:", THEME_NAME), "value" => "hide"),
		array("title" => __("Custom For Each Post:", THEME_NAME), "value" => "custom")
...
array(
	"type" => "radio",
	"id" => $different_themes_managment->themeslug."_comments",
	"radio" => array(
		array("title" => __("Show:", THEME_NAME), "value" => "show"),
		array("title" => __("Hide:", THEME_NAME), "value" => "hide"),
		array("title" => __("Custom For Each Post:", THEME_NAME), "value" => "custom")
...
array(
	"type" => "radio",
	"id" => $different_themes_managment->themeslug."_categories",
	"radio" => array(
		array("title" => __("Show:", THEME_NAME), "value" => "show"),
		array("title" => __("Hide:", THEME_NAME), "value" => "hide"),
		array("title" => __("Custom For Each Post:", THEME_NAME), "value" => "custom")
...
array(
	"type" => "radio",
	"id" => $different_themes_managment->themeslug."_tags",
	"radio" => array(
		array("title" => __("Show:", THEME_NAME), "value" => "show"),
		array("title" => __("Hide:", THEME_NAME), "value" => "hide"),
		array("title" => __("Custom For Each Post:", THEME_NAME), "value" => "custom")
...
array(
	"type" => "title",
	"title" => __("Show Post Views", THEME_NAME)
),

array(
	"type" => "radio",
	"id" => $different_themes_managment->themeslug."_views",
	"radio" => array(
		array("title" => __("Show:", THEME_NAME), "value" => "show"),
		array("title" => __("Hide:", THEME_NAME), "value" => "hide"),
		array("title" => __("Custom For Each Post:", THEME_NAME), "value" => "custom")
...
array(
	...
	"sample" => '<a href="http://www.different-themes.com" target="_blank"><img src="'.THEME_IMAGE_URL.'728x90.png" alt="" title=""/></a>',
