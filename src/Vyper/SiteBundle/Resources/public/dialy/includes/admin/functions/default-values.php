<?php
	...
	if ( is_admin() && isset($_GET['activated'] ) && $pagenow == 'themes.php' ) {
		...
		$banner = '	<a href="http://www.different-themes.com" target="_blank"><img src="'.THEME_IMAGE_URL.'728x90.png" alt="" title="" /></a>';
		...
		update_option(THEME_NAME.'_post_controls', "custom");
		update_option(THEME_NAME.'_comments', "custom");
		update_option(THEME_NAME.'_author', "custom");
		update_option(THEME_NAME.'_published', "custom");
		update_option(THEME_NAME.'_views', "custom");
		update_option(THEME_NAME.'_tags', "custom");
		update_option(THEME_NAME.'_categories', "custom");
		update_option(THEME_NAME.'_subcount', "5");
		...
		update_option(THEME_NAME.'_menu_style', 'dark');
		update_option(THEME_NAME.'_top_menu_style', 'dark');
		update_option(THEME_NAME.'_header_style', 'dark');

		update_option(THEME_NAME.'_color_1', '4a86b8');
		update_option(THEME_NAME.'_color_2', '4a86b8');
		update_option(THEME_NAME.'_color_3', '4a86b8');
		...
		update_option(THEME_NAME.'_show_single_thumb', "show");
		update_option(THEME_NAME.'_single_thumb_size', "custom");
	}
