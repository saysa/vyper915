...
<?php get_template_part(THEME_LOOP."loop-start"); ?> 
	<div class="blank-page-container">
        ...
        <div class="gallery-content">
			...
			<?php 
				$c=1;
				$src = get_post_thumb($post->ID,380,250);
				$term_list = wp_get_post_terms($post->ID, 'gallery-cat');
						
			?>
                <!-- Gallery album -->
                <div class="gallery-album sport-gal<?php foreach ($term_list as $term) { echo " ".$term->slug; } ?>">
                    <div class="gal-img">
                    	<a href="<?php the_permalink();?>">
                    		<span><?php printf ( __( '%1$s Images', THEME_NAME ), DF_image_count(get_the_ID()));?></span>
