        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-custom description description-wide">
                <label for="edit-menu-item-color-<?php echo $item_id; ?>">
                    ...
                    <?php _e( 'Show The Color Line In Main Menu Parent Item (Only Pages/Categories)', THEME_NAME ); ?>
                </label>
            </p>     
            <p class="field-custom description description-wide">
                <label for="edit-menu-menu_type-<?php echo $item_id; ?>">
                    <?php _e( 'Main menu type ( only menu parent item, more info <a href="http://novomag.orange-themes.com/documentation/#mega-menu" target="_blank">here</a> )', THEME_NAME ); ?><br/>
                    <select id="edit-menu-menu_type-<?php echo $item_id; ?>" name="menu-item-menu_type[<?php echo $item_id; ?>]">
                        <option value="1"<?php if($item->menu_type=="1") echo ' selected="selected"'; ?>><?php _e('Default', THEME_NAME ); ?></option>
                        <option value="2"<?php if($item->menu_type=="2") echo ' selected="selected"'; ?>><?php _e('Mega Menu', THEME_NAME ); ?></option>
                    </select>
                </label>
            </p>     
            <p class="field-custom description description-wide">
                <label for="edit-menu-icon-<?php echo $item_id; ?>">
                    <?php _e( 'Menu Icon (Only for main menu and only menu parent items)', THEME_NAME ); ?><br/>
