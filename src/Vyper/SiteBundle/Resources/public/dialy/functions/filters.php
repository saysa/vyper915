...
function df_fields($fields) {
	$fields['author'] = '<p class="comment-form-author"><label>'.__("Name:",THEME_NAME).'<span>*</span></label><input type="text" placeholder="'.__("Name..",THEME_NAME).'" name="author" id="author" required>';
