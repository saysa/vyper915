...
if(function_exists("is_bbpress")) {
	$different_sidebars[]=array('name'=>'bbPress Forum/Topic Sidebar', 'id'=>'bbpress_sidebar','description'=> __('BBpress page sidebar.', THEME_NAME));
}	
if(function_exists("bp_current_component")) {
	$different_sidebars[]=array('name'=>'BuddyPress Sidebar', 'id'=>'buddypress_sidebar','description'=> __('BuddyPress page sidebar.', THEME_NAME));
}
if(function_exists('is_woocommerce') ) {
	$different_sidebars[]=array('name'=>'Woocommerce Sidebar', 'id'=>'woocommerce_sidebar','description'=> __('Woocommerce page sidebar.', THEME_NAME));
}
